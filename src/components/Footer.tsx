...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-navy-700/80 bg-navy-950/90">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
        ...
        {/* Bottom bar */}
        <div className="mt-12 pt-8 border-t border-navy-700/60 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} KodLab. {t("rights")}
          </p>
          <div className="flex items-center gap-5">
            ...
            <a href="#" className="text-gray-500 hover:text-cyan-400 transition-colors" aria-label="LinkedIn">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
